    ...
    <section class="section">
        <div class="card">
            <div class="card-body position-relative p-5">
                <h3 class="fw-bold display-6 my-4 text-center">
                    Syarat & Ketentuan
                </h3>
                ...
                <div class="card-text mt-4" style="font-size: 1.1rem; line-height: 1.8;">
                    ...
                    <h6>Judul</h6>
                    <p>Singkat, jelas, dan sesuai topik.</p>
                    <p><strong>Contoh:</strong> “Mengenal Cloud Computing untuk Pemula”</p>

                    <h6>Pendahuluan</h6>
                    <p>Jelaskan topik secara sederhana dan kenapa penting bagi pembaca.</p>
                    ...
                    <h6>Kesimpulan</h6>
                    <p>Ringkas poin penting dari artikel.</p>
                    <p>Bisa tambahkan ajakan membaca artikel lain atau praktik sederhana.</p>

                    <h5 class="mb-3">2. Gaya Bahasa</h5>
                    <ul>
                    ...
                    <h5 class="mb-3">3. Sumber dan Akurasi</h5>
                    <ul>
                    ...
                    <h4 class="mb-3">Ketentuan Pemblokiran</h4>
                    <h5 class="mb-3">1. Blokir Pengguna</h5>
                    <h6>Alasan Pemblokiran:</h6>
                    <ul>
                    ...
                    <h6>Prosedur:</h6>
                    <ul>
                        <li>Pengguna yang terblokir tidak bisa login ke akunnya sampai admin mencabut status blokirnya.
                        </li>
                        <li>Pengguna yang terblokir silahkan menghubungi admin untuk membicarakan status blokirnya.</li>
                    </ul>

                    <h5 class="mb-3">2. Blokir Artikel</h5>
                    <h6>Alasan Pemblokiran:</h6>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>Pengguna yang artikelnya terblokir silahkan menghubungi admin untuk membicarakan status
                            blokirnya.</li>
                    </ul>

                    <h5 class="mb-3">3. Blokir Komentar</h5>
                    <h6>Alasan Pemblokiran:</h6>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>Pelanggaran berulang dapat menyebabkan akun diblokir sementara atau permanen dari memberi
                            komentar.</li>
                        <li>Pengguna yang terblokir silahkan menghubungi admin untuk membicarakan status blokirnya.</li>
                    </ul>
                </div>
